active = ((global.active_character==obj_JudyHopps) && (!global.dialogue));
...
if (active)
{
    ...
    key_sneak = (keyboard_check(vk_control)) || (keyboard_check(ord("S"))) || (keyboard_check(vk_down)) || ((place_meeting(x,y-16,obj_collide_parent)) && (sprite_index = spr_JudySneakRight || sprite_index = spr_JudyFlipRight));
    key_dialogue = 0;
}
else
{
...
if (global.dialogue) then sprite_index = spr_JudyTalkRight;
